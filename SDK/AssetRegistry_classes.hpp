...
{
public:
	uint8                                         Pad_30[0x878];                                     // 0x0030(0x0878)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x0008A8, "Wrong size on UAssetRegistryImpl");
...
public:
	...
	struct FAssetData GetAssetByGuid(const struct FGuid& PersistentGuid, bool bIncludeOnlyOnDiskAssets) const;
