...
public:
	...
	struct FVector2D                              ImageSize;                                         // 0x0050(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FSlateBrush                            OverrideBrush;                                     // 0x0028(0x0090)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCommonInputTypeInfo) == 0x000008, "Wrong alignment on FCommonInputTypeInfo");
static_assert(sizeof(FCommonInputTypeInfo) == 0x0000B8, "Wrong size on FCommonInputTypeInfo");
...
static_assert(offsetof(FCommonInputTypeInfo, OverrideBrush) == 0x000028, "Member 'FCommonInputTypeInfo::OverrideBrush' has a wrong offset!");
...
static_assert(sizeof(FCommonInputActionDataBase) == 0x0002B0, "Wrong size on FCommonInputActionDataBase");
...
static_assert(offsetof(FCommonInputActionDataBase, DefaultGamepadInputTypeInfo) == 0x0000F0, "Member 'FCommonInputActionDataBase::DefaultGamepadInputTypeInfo' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, GamepadInputOverrides) == 0x0001A8, "Member 'FCommonInputActionDataBase::GamepadInputOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, TouchInputTypeInfo) == 0x0001F8, "Member 'FCommonInputActionDataBase::TouchInputTypeInfo' has a wrong offset!");
