...
static_assert(sizeof(AARActor) == 0x000258, "Wrong size on AARActor");
...
static_assert(sizeof(UARComponent) == 0x0002D0, "Wrong size on UARComponent");
static_assert(offsetof(UARComponent, NativeID) == 0x000248, "Member 'UARComponent::NativeID' has a wrong offset!");
static_assert(offsetof(UARComponent, bUseDefaultReplication) == 0x000288, "Member 'UARComponent::bUseDefaultReplication' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultMeshMaterial) == 0x000290, "Member 'UARComponent::DefaultMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultWireframeMeshMaterial) == 0x000298, "Member 'UARComponent::DefaultWireframeMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, MRMeshComponent) == 0x0002A0, "Member 'UARComponent::MRMeshComponent' has a wrong offset!");
static_assert(offsetof(UARComponent, MyTrackedGeometry) == 0x0002A8, "Member 'UARComponent::MyTrackedGeometry' has a wrong offset!");
...
static_assert(sizeof(UARPlaneComponent) == 0x000350, "Wrong size on UARPlaneComponent");
static_assert(offsetof(UARPlaneComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARPlaneComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARPointComponent, ReplicatedPayload) == 0x0002C8, "Member 'UARPointComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARFaceComponent, TransformSetting) == 0x0002C8, "Member 'UARFaceComponent::TransformSetting' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bUpdateVertexNormal) == 0x0002C9, "Member 'UARFaceComponent::bUpdateVertexNormal' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bFaceOutOfScreen) == 0x0002CA, "Member 'UARFaceComponent::bFaceOutOfScreen' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARFaceComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARImageComponent) == 0x000330, "Wrong size on UARImageComponent");
static_assert(offsetof(UARImageComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARImageComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARQRCodeComponent) == 0x000340, "Wrong size on UARQRCodeComponent");
static_assert(offsetof(UARQRCodeComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARQRCodeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARPoseComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARPoseComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UAREnvironmentProbeComponent, ReplicatedPayload) == 0x0002D0, "Member 'UAREnvironmentProbeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARObjectComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARObjectComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARMeshComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARMeshComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(offsetof(UARGeoAnchorComponent, ReplicatedPayload) == 0x0002D0, "Member 'UARGeoAnchorComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnARActorSpawnedDelegate;                          // 0x0248(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnARActorToBeDestroyedDelegate;                    // 0x0258(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARLifeCycleComponent) == 0x000280, "Wrong size on UARLifeCycleComponent");
static_assert(offsetof(UARLifeCycleComponent, OnARActorSpawnedDelegate) == 0x000248, "Member 'UARLifeCycleComponent::OnARActorSpawnedDelegate' has a wrong offset!");
static_assert(offsetof(UARLifeCycleComponent, OnARActorToBeDestroyedDelegate) == 0x000258, "Member 'UARLifeCycleComponent::OnARActorToBeDestroyedDelegate' has a wrong offset!");
...
static_assert(sizeof(AAROriginActor) == 0x000258, "Wrong size on AAROriginActor");
...
{
public:
	int32                                         BufferSizePerChunk;                                // 0x0348(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34C[0x64];                                     // 0x034C(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldGameMode) == 0x0003B0, "Wrong size on AARSharedWorldGameMode");
static_assert(offsetof(AARSharedWorldGameMode, BufferSizePerChunk) == 0x000348, "Member 'AARSharedWorldGameMode::BufferSizePerChunk' has a wrong offset!");
...
static_assert(sizeof(AARSharedWorldGameState) == 0x000308, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x0002D0, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x0002E0, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x0002F0, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x0002F4, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x0002F8, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x0002FC, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
...
static_assert(sizeof(AARSharedWorldPlayerController) == 0x0005C8, "Wrong size on AARSharedWorldPlayerController");
...
static_assert(sizeof(AARSkyLight) == 0x000278, "Wrong size on AARSkyLight");
static_assert(offsetof(AARSkyLight, CaptureProbe) == 0x000268, "Member 'AARSkyLight::CaptureProbe' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnAddTrackedGeometry;                              // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedGeometry;                           // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedGeometry;                           // 0x0110(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedPlane;                                 // 0x0120(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedPlane;                              // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedPlane;                              // 0x0140(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedPoint;                                 // 0x0150(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedPoint;                              // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedPoint;                              // 0x0170(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedImage;                                 // 0x0180(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedImage;                              // 0x0190(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedImage;                              // 0x01A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedFace;                                  // 0x01B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedFace;                               // 0x01C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedFace;                               // 0x01D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedEnvProbe;                              // 0x01E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedEnvProbe;                           // 0x01F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedEnvProbe;                           // 0x0200(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedObject;                                // 0x0210(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedObject;                             // 0x0220(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedObject;                             // 0x0230(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARTrackableNotifyComponent) == 0x000240, "Wrong size on UARTrackableNotifyComponent");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedGeometry) == 0x0000F0, "Member 'UARTrackableNotifyComponent::OnAddTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedGeometry) == 0x000100, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedGeometry) == 0x000110, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPlane) == 0x000120, "Member 'UARTrackableNotifyComponent::OnAddTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPlane) == 0x000130, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPlane) == 0x000140, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPoint) == 0x000150, "Member 'UARTrackableNotifyComponent::OnAddTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPoint) == 0x000160, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPoint) == 0x000170, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedImage) == 0x000180, "Member 'UARTrackableNotifyComponent::OnAddTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedImage) == 0x000190, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedImage) == 0x0001A0, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedFace) == 0x0001B0, "Member 'UARTrackableNotifyComponent::OnAddTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedFace) == 0x0001C0, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedFace) == 0x0001D0, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedEnvProbe) == 0x0001E0, "Member 'UARTrackableNotifyComponent::OnAddTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedEnvProbe) == 0x0001F0, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedEnvProbe) == 0x000200, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedObject) == 0x000210, "Member 'UARTrackableNotifyComponent::OnAddTrackedObject' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedObject) == 0x000220, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedObject' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedObject) == 0x000230, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedObject' has a wrong offset!");
