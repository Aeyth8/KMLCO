...
{
public:
	class UGroomComponent*                        GroomComponent;                                    // 0x0258(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AGroomActor) == 0x000260, "Wrong size on AGroomActor");
static_assert(offsetof(AGroomActor, GroomComponent) == 0x000258, "Member 'AGroomActor::GroomComponent' has a wrong offset!");
...
public:
	...
	class UGroomAsset*                            GroomAsset;                                        // 0x0508(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomCache*                            GroomCache;                                        // 0x0510(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UNiagaraComponent*>              NiagaraComponents;                                 // 0x0518(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPublic)
	class USkeletalMesh*                          SourceSkeletalMesh;                                // 0x0528(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomBindingAsset*                     BindingAsset;                                      // 0x0530(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPhysicsAsset*                          PhysicsAsset;                                      // 0x0538(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DebugMaterial;                             // 0x0540(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DefaultMaterial;                           // 0x0548(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Cards_DefaultMaterial;                             // 0x0550(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Meshes_DefaultMaterial;                            // 0x0558(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         AngularSpringsSystem;                              // 0x0560(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         CosseratRodsSystem;                                // 0x0568(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AttachmentName;                                    // 0x0570(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Interp, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_580[0x50];                                     // 0x0580(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FHairGroupDesc>                 GroomGroupsDesc;                                   // 0x05D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bRunning;                                          // 0x05E0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bLooping;                                          // 0x05E1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bManualTick;                                       // 0x05E2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5E3[0x1];                                      // 0x05E3(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ElapsedTime;                                       // 0x05E4(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGroomComponent) == 0x000630, "Wrong size on UGroomComponent");
...
static_assert(offsetof(UGroomComponent, Strands_DebugMaterial) == 0x000540, "Member 'UGroomComponent::Strands_DebugMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DefaultMaterial) == 0x000548, "Member 'UGroomComponent::Strands_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Cards_DefaultMaterial) == 0x000550, "Member 'UGroomComponent::Cards_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Meshes_DefaultMaterial) == 0x000558, "Member 'UGroomComponent::Meshes_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AngularSpringsSystem) == 0x000560, "Member 'UGroomComponent::AngularSpringsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, CosseratRodsSystem) == 0x000568, "Member 'UGroomComponent::CosseratRodsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AttachmentName) == 0x000570, "Member 'UGroomComponent::AttachmentName' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomGroupsDesc) == 0x0005D0, "Member 'UGroomComponent::GroomGroupsDesc' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bRunning) == 0x0005E0, "Member 'UGroomComponent::bRunning' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bLooping) == 0x0005E1, "Member 'UGroomComponent::bLooping' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bManualTick) == 0x0005E2, "Member 'UGroomComponent::bManualTick' has a wrong offset!");
static_assert(offsetof(UGroomComponent, ElapsedTime) == 0x0005E4, "Member 'UGroomComponent::ElapsedTime' has a wrong offset!");
