...
#include "BP_ExplosionEliteStun_classes.hpp"
#include "BP_ExplosionEliteStun_parameters.hpp"
...
void ABP_ExplosionEliteStun_C::ExecuteUbergraph_BP_ExplosionEliteStun(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionEliteStun_C", "ExecuteUbergraph_BP_ExplosionEliteStun");

	Params::BP_ExplosionEliteStun_C_ExecuteUbergraph_BP_ExplosionEliteStun Parms{};
...
void ABP_ExplosionEliteStun_C::OnTrigger(const struct FVector& Epicenter, float Radius, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionEliteStun_C", "OnTrigger");

	Params::BP_ExplosionEliteStun_C_OnTrigger Parms{};
