...
{
public:
	class UHoudiniAssetComponent*                 HoudiniAssetComponent;                             // 0x0258(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AHoudiniAssetActor) == 0x000260, "Wrong size on AHoudiniAssetActor");
static_assert(offsetof(AHoudiniAssetActor, HoudiniAssetComponent) == 0x000258, "Member 'AHoudiniAssetActor::HoudiniAssetComponent' has a wrong offset!");

// Class HoudiniEngineRuntime.HoudiniAssetComponent
// 0x04D0 (0x09A0 - 0x04D0)
...
public:
	...
	class UHoudiniAsset*                          HoudiniAsset;                                      // 0x04D0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnParameterChange;                            // 0x04D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUploadTransformsToHoudiniEngine;                  // 0x04D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnTransformChange;                            // 0x04DA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnAssetInputCook;                             // 0x04DB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOutputless;                                       // 0x04DC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOutputTemplateGeos;                               // 0x04DD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseOutputNodes;                                   // 0x04DE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4DF[0x1];                                      // 0x04DF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDirectoryPath                         TemporaryCookFolder;                               // 0x04E0(0x0010)(NativeAccessSpecifierPublic)
	struct FDirectoryPath                         BakeFolder;                                        // 0x04F0(0x0010)(NativeAccessSpecifierPublic)
	EHoudiniStaticMeshMethod                      StaticMeshMethod;                                  // 0x0500(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_501[0x7];                                      // 0x0501(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHoudiniStaticMeshGenerationProperties StaticMeshGenerationProperties;                    // 0x0508(0x01B0)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FMeshBuildSettings                     StaticMeshBuildSettings;                           // 0x06B8(0x0030)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bOverrideGlobalProxyStaticMeshSettings;            // 0x06E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableProxyStaticMeshOverride;                    // 0x06E9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableProxyStaticMeshRefinementByTimerOverride;   // 0x06EA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6EB[0x1];                                      // 0x06EB(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ProxyMeshAutoRefineTimeoutSecondsOverride;         // 0x06EC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride; // 0x06F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride; // 0x06F1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6F2[0x2];                                      // 0x06F2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         AssetId;                                           // 0x06F4(0x0004)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<int32>                                 NodeIdsToCook;                                     // 0x06F8(0x0010)(ZeroConstructor, Transient, DuplicateTransient, Protected, NativeAccessSpecifierProtected)
	TMap<int32, int32>                            OutputNodeCookCounts;                              // 0x0708(0x0050)(Transient, DuplicateTransient, Protected, NativeAccessSpecifierProtected)
	TSet<class UHoudiniAssetComponent*>           DownstreamHoudiniAssets;                           // 0x0758(0x0050)(ExportObject, DuplicateTransient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FGuid                                  ComponentGUID;                                     // 0x07A8(0x0010)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGuid                                  HapiGUID;                                          // 0x07B8(0x0010)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 HapiAssetName;                                     // 0x07C8(0x0010)(ZeroConstructor, DuplicateTransient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EHoudiniAssetState                            AssetState;                                        // 0x07D8(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EHoudiniAssetState                            DebugLastAssetState;                               // 0x07D9(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EHoudiniAssetStateResult                      AssetStateResult;                                  // 0x07DA(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7DB[0x5];                                      // 0x07DB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             LastComponentTransform;                            // 0x07E0(0x0030)(DuplicateTransient, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint32                                        SubAssetIndex;                                     // 0x0810(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         AssetCookCount;                                    // 0x0814(0x0004)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHasBeenLoaded;                                    // 0x0818(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHasBeenDuplicated;                                // 0x0819(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPendingDelete;                                    // 0x081A(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRecookRequested;                                  // 0x081B(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRebuildRequested;                                 // 0x081C(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableCooking;                                    // 0x081D(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bForceNeedUpdate;                                  // 0x081E(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bLastCookSuccess;                                  // 0x081F(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bParameterDefinitionUpdateNeeded;                  // 0x0820(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bBlueprintStructureModified;                       // 0x0821(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bBlueprintModified;                                // 0x0822(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_823[0x5];                                      // 0x0823(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UHoudiniParameter*>              Parameters;                                        // 0x0828(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UHoudiniInput*>                  Inputs;                                            // 0x0838(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class UHoudiniOutput*>                 Outputs;                                           // 0x0848(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FHoudiniBakedOutput>            BakedOutputs;                                      // 0x0858(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<TWeakObjectPtr<class AActor>>          UntrackedOutputs;                                  // 0x0868(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UHoudiniHandleComponent*>        HandleComponents;                                  // 0x0878(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	bool                                          bHasComponentTransformChanged;                     // 0x0888(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bFullyLoaded;                                      // 0x0889(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_88A[0x6];                                      // 0x088A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UHoudiniPDGAssetLink*                   PDGAssetLink;                                      // 0x0890(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FTimerHandle                           RefineMeshesTimer;                                 // 0x0898(0x0008)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8A0[0x18];                                     // 0x08A0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bNoProxyMeshNextCookRequested;                     // 0x08B8(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8B9[0x7];                                      // 0x08B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UObject*, int32>                   InputPresets;                                      // 0x08C0(0x0050)(Transient, DuplicateTransient, Protected, NativeAccessSpecifierProtected)
	bool                                          bBakeAfterNextCook;                                // 0x0910(0x0001)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_911[0x5F];                                     // 0x0911(0x005F)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bCachedIsPreview;                                  // 0x0970(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_971[0xF];                                      // 0x0971(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        LastTickTime;                                      // 0x0980(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniAssetComponent) == 0x0009A0, "Wrong size on UHoudiniAssetComponent");
static_assert(offsetof(UHoudiniAssetComponent, HoudiniAsset) == 0x0004D0, "Member 'UHoudiniAssetComponent::HoudiniAsset' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnParameterChange) == 0x0004D8, "Member 'UHoudiniAssetComponent::bCookOnParameterChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUploadTransformsToHoudiniEngine) == 0x0004D9, "Member 'UHoudiniAssetComponent::bUploadTransformsToHoudiniEngine' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnTransformChange) == 0x0004DA, "Member 'UHoudiniAssetComponent::bCookOnTransformChange' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCookOnAssetInputCook) == 0x0004DB, "Member 'UHoudiniAssetComponent::bCookOnAssetInputCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputless) == 0x0004DC, "Member 'UHoudiniAssetComponent::bOutputless' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOutputTemplateGeos) == 0x0004DD, "Member 'UHoudiniAssetComponent::bOutputTemplateGeos' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bUseOutputNodes) == 0x0004DE, "Member 'UHoudiniAssetComponent::bUseOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, TemporaryCookFolder) == 0x0004E0, "Member 'UHoudiniAssetComponent::TemporaryCookFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakeFolder) == 0x0004F0, "Member 'UHoudiniAssetComponent::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshMethod) == 0x000500, "Member 'UHoudiniAssetComponent::StaticMeshMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshGenerationProperties) == 0x000508, "Member 'UHoudiniAssetComponent::StaticMeshGenerationProperties' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, StaticMeshBuildSettings) == 0x0006B8, "Member 'UHoudiniAssetComponent::StaticMeshBuildSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bOverrideGlobalProxyStaticMeshSettings) == 0x0006E8, "Member 'UHoudiniAssetComponent::bOverrideGlobalProxyStaticMeshSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshOverride) == 0x0006E9, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementByTimerOverride) == 0x0006EA, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementByTimerOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, ProxyMeshAutoRefineTimeoutSecondsOverride) == 0x0006EC, "Member 'UHoudiniAssetComponent::ProxyMeshAutoRefineTimeoutSecondsOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride) == 0x0006F0, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementOnPreSaveWorldOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride) == 0x0006F1, "Member 'UHoudiniAssetComponent::bEnableProxyStaticMeshRefinementOnPreBeginPIEOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetId) == 0x0006F4, "Member 'UHoudiniAssetComponent::AssetId' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, NodeIdsToCook) == 0x0006F8, "Member 'UHoudiniAssetComponent::NodeIdsToCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, OutputNodeCookCounts) == 0x000708, "Member 'UHoudiniAssetComponent::OutputNodeCookCounts' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, DownstreamHoudiniAssets) == 0x000758, "Member 'UHoudiniAssetComponent::DownstreamHoudiniAssets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, ComponentGUID) == 0x0007A8, "Member 'UHoudiniAssetComponent::ComponentGUID' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HapiGUID) == 0x0007B8, "Member 'UHoudiniAssetComponent::HapiGUID' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HapiAssetName) == 0x0007C8, "Member 'UHoudiniAssetComponent::HapiAssetName' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetState) == 0x0007D8, "Member 'UHoudiniAssetComponent::AssetState' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, DebugLastAssetState) == 0x0007D9, "Member 'UHoudiniAssetComponent::DebugLastAssetState' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetStateResult) == 0x0007DA, "Member 'UHoudiniAssetComponent::AssetStateResult' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, LastComponentTransform) == 0x0007E0, "Member 'UHoudiniAssetComponent::LastComponentTransform' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, SubAssetIndex) == 0x000810, "Member 'UHoudiniAssetComponent::SubAssetIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetCookCount) == 0x000814, "Member 'UHoudiniAssetComponent::AssetCookCount' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenLoaded) == 0x000818, "Member 'UHoudiniAssetComponent::bHasBeenLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenDuplicated) == 0x000819, "Member 'UHoudiniAssetComponent::bHasBeenDuplicated' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bPendingDelete) == 0x00081A, "Member 'UHoudiniAssetComponent::bPendingDelete' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRecookRequested) == 0x00081B, "Member 'UHoudiniAssetComponent::bRecookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRebuildRequested) == 0x00081C, "Member 'UHoudiniAssetComponent::bRebuildRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableCooking) == 0x00081D, "Member 'UHoudiniAssetComponent::bEnableCooking' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bForceNeedUpdate) == 0x00081E, "Member 'UHoudiniAssetComponent::bForceNeedUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bLastCookSuccess) == 0x00081F, "Member 'UHoudiniAssetComponent::bLastCookSuccess' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bParameterDefinitionUpdateNeeded) == 0x000820, "Member 'UHoudiniAssetComponent::bParameterDefinitionUpdateNeeded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintStructureModified) == 0x000821, "Member 'UHoudiniAssetComponent::bBlueprintStructureModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintModified) == 0x000822, "Member 'UHoudiniAssetComponent::bBlueprintModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Parameters) == 0x000828, "Member 'UHoudiniAssetComponent::Parameters' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Inputs) == 0x000838, "Member 'UHoudiniAssetComponent::Inputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Outputs) == 0x000848, "Member 'UHoudiniAssetComponent::Outputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakedOutputs) == 0x000858, "Member 'UHoudiniAssetComponent::BakedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, UntrackedOutputs) == 0x000868, "Member 'UHoudiniAssetComponent::UntrackedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HandleComponents) == 0x000878, "Member 'UHoudiniAssetComponent::HandleComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasComponentTransformChanged) == 0x000888, "Member 'UHoudiniAssetComponent::bHasComponentTransformChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bFullyLoaded) == 0x000889, "Member 'UHoudiniAssetComponent::bFullyLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, PDGAssetLink) == 0x000890, "Member 'UHoudiniAssetComponent::PDGAssetLink' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, RefineMeshesTimer) == 0x000898, "Member 'UHoudiniAssetComponent::RefineMeshesTimer' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bNoProxyMeshNextCookRequested) == 0x0008B8, "Member 'UHoudiniAssetComponent::bNoProxyMeshNextCookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, InputPresets) == 0x0008C0, "Member 'UHoudiniAssetComponent::InputPresets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBakeAfterNextCook) == 0x000910, "Member 'UHoudiniAssetComponent::bBakeAfterNextCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCachedIsPreview) == 0x000970, "Member 'UHoudiniAssetComponent::bCachedIsPreview' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, LastTickTime) == 0x000980, "Member 'UHoudiniAssetComponent::LastTickTime' has a wrong offset!");
...
{
public:
	uint8                                         Pad_9A0[0x48];                                     // 0x09A0(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          FauxBPProperty;                                    // 0x09E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHoudiniAssetChanged;                              // 0x09E9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUpdatedFromTemplate;                              // 0x09EA(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsInBlueprintEditor;                              // 0x09EB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bCanDeleteHoudiniNodes;                            // 0x09EC(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bHasRegisteredComponentTemplate;                   // 0x09ED(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_9EE[0xA];                                      // 0x09EE(0x000A)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FHoudiniOutputObjectIdentifier, struct FGuid> CachedOutputNodes;                                 // 0x09F8(0x0050)(Protected, NativeAccessSpecifierProtected)
	TMap<struct FGuid, struct FGuid>              CachedInputNodes;                                  // 0x0A48(0x0050)(Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UHoudiniAssetBlueprintComponent, FauxBPProperty) == 0x0009E8, "Member 'UHoudiniAssetBlueprintComponent::FauxBPProperty' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHoudiniAssetChanged) == 0x0009E9, "Member 'UHoudiniAssetBlueprintComponent::bHoudiniAssetChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bUpdatedFromTemplate) == 0x0009EA, "Member 'UHoudiniAssetBlueprintComponent::bUpdatedFromTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bIsInBlueprintEditor) == 0x0009EB, "Member 'UHoudiniAssetBlueprintComponent::bIsInBlueprintEditor' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bCanDeleteHoudiniNodes) == 0x0009EC, "Member 'UHoudiniAssetBlueprintComponent::bCanDeleteHoudiniNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHasRegisteredComponentTemplate) == 0x0009ED, "Member 'UHoudiniAssetBlueprintComponent::bHasRegisteredComponentTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedOutputNodes) == 0x0009F8, "Member 'UHoudiniAssetBlueprintComponent::CachedOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedInputNodes) == 0x000A48, "Member 'UHoudiniAssetBlueprintComponent::CachedInputNodes' has a wrong offset!");
...
{
public:
	uint8                                         Pad_248[0x98];                                     // 0x0248(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UHoudiniHandleComponent_V1) == 0x0002E0, "Wrong size on UHoudiniHandleComponent_V1");
...
static_assert(sizeof(UHoudiniSplineComponent_V1) == 0x000340, "Wrong size on UHoudiniSplineComponent_V1");
...
{
public:
	uint8                                         bGeneratedDoubleSidedGeometry : 1;                 // 0x04C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_4C9[0x7];                                      // 0x04C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPhysicalMaterial*                      GeneratedPhysMaterial;                             // 0x04D0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBodyInstance                          DefaultBodyInstance;                               // 0x04D8(0x0160)(Edit, NativeAccessSpecifierPublic)
	ECollisionTraceFlag                           GeneratedCollisionTraceFlag;                       // 0x0638(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_639[0x3];                                      // 0x0639(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         GeneratedLightMapResolution;                       // 0x063C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GeneratedDistanceFieldResolutionScale;             // 0x0640(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWalkableSlopeOverride                 GeneratedWalkableSlopeOverride;                    // 0x0644(0x0010)(Edit, IsPlainOldData, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	int32                                         GeneratedLightMapCoordinateIndex;                  // 0x0654(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bGeneratedUseMaximumStreamingTexelRatio : 1;       // 0x0658(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_659[0x3];                                      // 0x0659(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GeneratedStreamingDistanceMultiplier;              // 0x065C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFoliageType_InstancedStaticMesh*       GeneratedFoliageDefaultSettings;                   // 0x0660(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, AdvancedDisplay, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UAssetUserData*>                 GeneratedAssetUserData;                            // 0x0668(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, AdvancedDisplay, NativeAccessSpecifierPublic)
	class FText                                   BakeFolder;                                        // 0x0678(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   TempCookFolder;                                    // 0x0690(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_6A8[0x348];                                    // 0x06A8(0x0348)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UHoudiniAssetComponent_V1) == 0x0009F0, "Wrong size on UHoudiniAssetComponent_V1");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedPhysMaterial) == 0x0004D0, "Member 'UHoudiniAssetComponent_V1::GeneratedPhysMaterial' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, DefaultBodyInstance) == 0x0004D8, "Member 'UHoudiniAssetComponent_V1::DefaultBodyInstance' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedCollisionTraceFlag) == 0x000638, "Member 'UHoudiniAssetComponent_V1::GeneratedCollisionTraceFlag' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapResolution) == 0x00063C, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedDistanceFieldResolutionScale) == 0x000640, "Member 'UHoudiniAssetComponent_V1::GeneratedDistanceFieldResolutionScale' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedWalkableSlopeOverride) == 0x000644, "Member 'UHoudiniAssetComponent_V1::GeneratedWalkableSlopeOverride' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedLightMapCoordinateIndex) == 0x000654, "Member 'UHoudiniAssetComponent_V1::GeneratedLightMapCoordinateIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedStreamingDistanceMultiplier) == 0x00065C, "Member 'UHoudiniAssetComponent_V1::GeneratedStreamingDistanceMultiplier' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedFoliageDefaultSettings) == 0x000660, "Member 'UHoudiniAssetComponent_V1::GeneratedFoliageDefaultSettings' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, GeneratedAssetUserData) == 0x000668, "Member 'UHoudiniAssetComponent_V1::GeneratedAssetUserData' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, BakeFolder) == 0x000678, "Member 'UHoudiniAssetComponent_V1::BakeFolder' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent_V1, TempCookFolder) == 0x000690, "Member 'UHoudiniAssetComponent_V1::TempCookFolder' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInstancedActorComponent_V1) == 0x000260, "Wrong size on UHoudiniInstancedActorComponent_V1");
...
static_assert(sizeof(UHoudiniMeshSplitInstancerComponent_V1) == 0x000270, "Wrong size on UHoudiniMeshSplitInstancerComponent_V1");
...
{
public:
	TArray<class UHoudiniHandleParameter*>        XformParms;                                        // 0x0248(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class UHoudiniHandleParameter*                RSTParm;                                           // 0x0258(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UHoudiniHandleParameter*                RotOrderParm;                                      // 0x0260(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniHandleType                            HandleType;                                        // 0x0268(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_269[0x7];                                      // 0x0269(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 HandleName;                                        // 0x0270(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniHandleComponent) == 0x000280, "Wrong size on UHoudiniHandleComponent");
static_assert(offsetof(UHoudiniHandleComponent, XformParms) == 0x000248, "Member 'UHoudiniHandleComponent::XformParms' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, RSTParm) == 0x000258, "Member 'UHoudiniHandleComponent::RSTParm' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, RotOrderParm) == 0x000260, "Member 'UHoudiniHandleComponent::RotOrderParm' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, HandleType) == 0x000268, "Member 'UHoudiniHandleComponent::HandleType' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, HandleName) == 0x000270, "Member 'UHoudiniHandleComponent::HandleName' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInput) == 0x000218, "Wrong size on UHoudiniInput");
...
public:
	...
	bool                                          bImportAsReferenceBboxEnabled;                     // 0x00B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bImportAsReferenceMaterialEnabled;                 // 0x00B2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	bool                                          bCanDeleteHoudiniNodes;                            // 0x00C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniInputObject) == 0x0000D0, "Wrong size on UHoudiniInputObject");
...
static_assert(offsetof(UHoudiniInputObject, bImportAsReferenceBboxEnabled) == 0x0000B1, "Member 'UHoudiniInputObject::bImportAsReferenceBboxEnabled' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bImportAsReferenceMaterialEnabled) == 0x0000B2, "Member 'UHoudiniInputObject::bImportAsReferenceMaterialEnabled' has a wrong offset!");
...
static_assert(offsetof(UHoudiniInputObject, bCanDeleteHoudiniNodes) == 0x0000C8, "Member 'UHoudiniInputObject::bCanDeleteHoudiniNodes' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputSkeletalMesh) == 0x0000D0, "Wrong size on UHoudiniInputSkeletalMesh");
...
static_assert(sizeof(UHoudiniInputGeometryCollection) == 0x0000D0, "Wrong size on UHoudiniInputGeometryCollection");
...
{
public:
	struct FTransform                             ActorTransform;                                    // 0x00D0(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniInputSceneComponent) == 0x000100, "Wrong size on UHoudiniInputSceneComponent");
static_assert(offsetof(UHoudiniInputSceneComponent, ActorTransform) == 0x0000D0, "Member 'UHoudiniInputSceneComponent::ActorTransform' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UStaticMesh>             StaticMesh;                                        // 0x0100(0x0030)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UHoudiniInputMeshComponent, StaticMesh) == 0x000100, "Member 'UHoudiniInputMeshComponent::StaticMesh' has a wrong offset!");
...
{
public:
	int32                                         NumberOfSplineControlPoints;                       // 0x0100(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SplineLength;                                      // 0x0104(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SplineResolution;                                  // 0x0108(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          SplineClosed;                                      // 0x010C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10D[0x3];                                      // 0x010D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTransform>                     SplineControlPoints;                               // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniInputSplineComponent) == 0x000120, "Wrong size on UHoudiniInputSplineComponent");
static_assert(offsetof(UHoudiniInputSplineComponent, NumberOfSplineControlPoints) == 0x000100, "Member 'UHoudiniInputSplineComponent::NumberOfSplineControlPoints' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineLength) == 0x000104, "Member 'UHoudiniInputSplineComponent::SplineLength' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineResolution) == 0x000108, "Member 'UHoudiniInputSplineComponent::SplineResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineClosed) == 0x00010C, "Member 'UHoudiniInputSplineComponent::SplineClosed' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineControlPoints) == 0x000110, "Member 'UHoudiniInputSplineComponent::SplineControlPoints' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputGeometryCollectionComponent) == 0x000100, "Wrong size on UHoudiniInputGeometryCollectionComponent");
...
{
public:
	EHoudiniCurveType                             CurveType;                                         // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveMethod                           CurveMethod;                                       // 0x00D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Reversed;                                          // 0x00D2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D3[0x5];                                       // 0x00D3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UHoudiniSplineComponent*                CachedComponent;                                   // 0x00D8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniInputHoudiniSplineComponent) == 0x0000E0, "Wrong size on UHoudiniInputHoudiniSplineComponent");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CurveType) == 0x0000D0, "Member 'UHoudiniInputHoudiniSplineComponent::CurveType' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CurveMethod) == 0x0000D1, "Member 'UHoudiniInputHoudiniSplineComponent::CurveMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, Reversed) == 0x0000D2, "Member 'UHoudiniInputHoudiniSplineComponent::Reversed' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CachedComponent) == 0x0000D8, "Member 'UHoudiniInputHoudiniSplineComponent::CachedComponent' has a wrong offset!");
...
{
public:
	float                                         FOV;                                               // 0x0100(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AspectRatio;                                       // 0x0104(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsOrthographic;                                   // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_109[0x3];                                      // 0x0109(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OrthoWidth;                                        // 0x010C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OrthoNearClipPlane;                                // 0x0110(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OrthoFarClipPlane;                                 // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniInputCameraComponent) == 0x000120, "Wrong size on UHoudiniInputCameraComponent");
static_assert(offsetof(UHoudiniInputCameraComponent, FOV) == 0x000100, "Member 'UHoudiniInputCameraComponent::FOV' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, AspectRatio) == 0x000104, "Member 'UHoudiniInputCameraComponent::AspectRatio' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, bIsOrthographic) == 0x000108, "Member 'UHoudiniInputCameraComponent::bIsOrthographic' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, OrthoWidth) == 0x00010C, "Member 'UHoudiniInputCameraComponent::OrthoWidth' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, OrthoNearClipPlane) == 0x000110, "Member 'UHoudiniInputCameraComponent::OrthoNearClipPlane' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, OrthoFarClipPlane) == 0x000114, "Member 'UHoudiniInputCameraComponent::OrthoFarClipPlane' has a wrong offset!");
...
{
public:
	int32                                         AssetOutputIndex;                                  // 0x00D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UHoudiniInputHoudiniAsset, AssetOutputIndex) == 0x0000D0, "Member 'UHoudiniInputHoudiniAsset::AssetOutputIndex' has a wrong offset!");
...
{
public:
	TArray<class UHoudiniInputSceneComponent*>    ActorComponents;                                   // 0x00D0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TSet<TSoftObjectPtr<class UObject>>           ActorSceneComponents;                              // 0x00E0(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsAdded;                      // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsRemoved;                    // 0x0134(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UHoudiniInputActor, ActorComponents) == 0x0000D0, "Member 'UHoudiniInputActor::ActorComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, ActorSceneComponents) == 0x0000E0, "Member 'UHoudiniInputActor::ActorSceneComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, LastUpdateNumComponentsAdded) == 0x000130, "Member 'UHoudiniInputActor::LastUpdateNumComponentsAdded' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, LastUpdateNumComponentsRemoved) == 0x000134, "Member 'UHoudiniInputActor::LastUpdateNumComponentsRemoved' has a wrong offset!");
...
public:
	...
	struct FTransform                             CachedInputLandscapeTraqnsform;                    // 0x0140(0x0030)(IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         CachedNumLandscapeComponents;                      // 0x0170(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHoudiniInputLandscape) == 0x000180, "Wrong size on UHoudiniInputLandscape");
...
static_assert(offsetof(UHoudiniInputLandscape, CachedNumLandscapeComponents) == 0x000170, "Member 'UHoudiniInputLandscape::CachedNumLandscapeComponents' has a wrong offset!");
...
{
public:
	TArray<struct FHoudiniBrushInfo>              BrushesInfo;                                       // 0x0138(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UModel*                                 CombinedModel;                                     // 0x0148(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIgnoreInputObject;                                // 0x0150(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EBrushType                                    CachedInputBrushType;                              // 0x0151(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UHoudiniInputBrush, BrushesInfo) == 0x000138, "Member 'UHoudiniInputBrush::BrushesInfo' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, CombinedModel) == 0x000148, "Member 'UHoudiniInputBrush::CombinedModel' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, bIgnoreInputObject) == 0x000150, "Member 'UHoudiniInputBrush::bIgnoreInputObject' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, CachedInputBrushType) == 0x000151, "Member 'UHoudiniInputBrush::CachedInputBrushType' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputDataTable) == 0x0000D0, "Wrong size on UHoudiniInputDataTable");
...
{
public:
	TArray<class UHoudiniInputSceneComponent*>    BPComponents;                                      // 0x00D0(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TSet<TSoftObjectPtr<class UObject>>           BPSceneComponents;                                 // 0x00E0(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsAdded;                      // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         LastUpdateNumComponentsRemoved;                    // 0x0134(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UHoudiniInputBlueprint) == 0x000140, "Wrong size on UHoudiniInputBlueprint");
static_assert(offsetof(UHoudiniInputBlueprint, BPComponents) == 0x0000D0, "Member 'UHoudiniInputBlueprint::BPComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBlueprint, BPSceneComponents) == 0x0000E0, "Member 'UHoudiniInputBlueprint::BPSceneComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBlueprint, LastUpdateNumComponentsAdded) == 0x000130, "Member 'UHoudiniInputBlueprint::LastUpdateNumComponentsAdded' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBlueprint, LastUpdateNumComponentsRemoved) == 0x000134, "Member 'UHoudiniInputBlueprint::LastUpdateNumComponentsRemoved' has a wrong offset!");
...
{
public:
	class UObject*                                InstancedObject;                                   // 0x0248(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class AActor*>                         InstancedActors;                                   // 0x0250(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniInstancedActorComponent) == 0x000260, "Wrong size on UHoudiniInstancedActorComponent");
static_assert(offsetof(UHoudiniInstancedActorComponent, InstancedObject) == 0x000248, "Member 'UHoudiniInstancedActorComponent::InstancedObject' has a wrong offset!");
static_assert(offsetof(UHoudiniInstancedActorComponent, InstancedActors) == 0x000250, "Member 'UHoudiniInstancedActorComponent::InstancedActors' has a wrong offset!");
...
{
public:
	TArray<class UStaticMeshComponent*>           Instances;                                         // 0x0248(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UMaterialInterface*>             OverrideMaterials;                                 // 0x0258(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPrivate)
	class UStaticMesh*                            InstancedMesh;                                     // 0x0268(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniMeshSplitInstancerComponent) == 0x000270, "Wrong size on UHoudiniMeshSplitInstancerComponent");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, Instances) == 0x000248, "Member 'UHoudiniMeshSplitInstancerComponent::Instances' has a wrong offset!");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, OverrideMaterials) == 0x000258, "Member 'UHoudiniMeshSplitInstancerComponent::OverrideMaterials' has a wrong offset!");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, InstancedMesh) == 0x000268, "Member 'UHoudiniMeshSplitInstancerComponent::InstancedMesh' has a wrong offset!");
...
public:
	...
	struct FDirectoryPath                         CustomHoudiniLocation;                             // 0x0298(0x0010)(Edit, Config, EditConst, GlobalConfig, NativeAccessSpecifierPublic)
...
// 0x02A0 (0x04F0 - 0x0250)
class UHoudiniSplineComponent final : public USceneComponent
{
public:
	uint8                                         Pad_248[0x8];                                      // 0x0248(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTransform>                     CurvePoints;                                       // 0x0250(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FVector>                        DisplayPoints;                                     // 0x0260(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 DisplayPointIndexDivider;                          // 0x0270(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class FString                                 HoudiniSplineName;                                 // 0x0280(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClosed;                                           // 0x0290(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bReversed;                                         // 0x0291(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_292[0x2];                                      // 0x0292(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CurveOrder;                                        // 0x0294(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsHoudiniSplineVisible;                           // 0x0298(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveType                             CurveType;                                         // 0x0299(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveMethod                           CurveMethod;                                       // 0x029A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHoudiniCurveBreakpointParameterization       CurveBreakpointParameterization;                   // 0x029B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsOutputCurve;                                    // 0x029C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCookOnCurveChanged;                               // 0x029D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsLegacyInputCurve;                               // 0x029E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29F[0x231];                                    // 0x029F(0x0231)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bHasChanged;                                       // 0x04D0(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bNeedsToTriggerUpdate;                             // 0x04D1(0x0001)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsInputCurve;                                     // 0x04D2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsEditableOutputCurve;                            // 0x04D3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         NodeId;                                            // 0x04D4(0x0004)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FString                                 PartName;                                          // 0x04D8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UHoudiniSplineComponent) == 0x0004F0, "Wrong size on UHoudiniSplineComponent");
static_assert(offsetof(UHoudiniSplineComponent, CurvePoints) == 0x000250, "Member 'UHoudiniSplineComponent::CurvePoints' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, DisplayPoints) == 0x000260, "Member 'UHoudiniSplineComponent::DisplayPoints' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, DisplayPointIndexDivider) == 0x000270, "Member 'UHoudiniSplineComponent::DisplayPointIndexDivider' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, HoudiniSplineName) == 0x000280, "Member 'UHoudiniSplineComponent::HoudiniSplineName' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bClosed) == 0x000290, "Member 'UHoudiniSplineComponent::bClosed' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bReversed) == 0x000291, "Member 'UHoudiniSplineComponent::bReversed' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveOrder) == 0x000294, "Member 'UHoudiniSplineComponent::CurveOrder' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsHoudiniSplineVisible) == 0x000298, "Member 'UHoudiniSplineComponent::bIsHoudiniSplineVisible' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveType) == 0x000299, "Member 'UHoudiniSplineComponent::CurveType' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveMethod) == 0x00029A, "Member 'UHoudiniSplineComponent::CurveMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveBreakpointParameterization) == 0x00029B, "Member 'UHoudiniSplineComponent::CurveBreakpointParameterization' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsOutputCurve) == 0x00029C, "Member 'UHoudiniSplineComponent::bIsOutputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bCookOnCurveChanged) == 0x00029D, "Member 'UHoudiniSplineComponent::bCookOnCurveChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsLegacyInputCurve) == 0x00029E, "Member 'UHoudiniSplineComponent::bIsLegacyInputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bHasChanged) == 0x0004D0, "Member 'UHoudiniSplineComponent::bHasChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bNeedsToTriggerUpdate) == 0x0004D1, "Member 'UHoudiniSplineComponent::bNeedsToTriggerUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsInputCurve) == 0x0004D2, "Member 'UHoudiniSplineComponent::bIsInputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsEditableOutputCurve) == 0x0004D3, "Member 'UHoudiniSplineComponent::bIsEditableOutputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, NodeId) == 0x0004D4, "Member 'UHoudiniSplineComponent::NodeId' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, PartName) == 0x0004D8, "Member 'UHoudiniSplineComponent::PartName' has a wrong offset!");
...
{
public:
	class UHoudiniStaticMesh*                     Mesh;                                              // 0x0500(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FBox                                   LocalBounds;                                       // 0x0508(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	bool                                          bHoudiniIconVisible;                               // 0x0524(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_525[0xB];                                      // 0x0525(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UHoudiniStaticMeshComponent, Mesh) == 0x000500, "Member 'UHoudiniStaticMeshComponent::Mesh' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, LocalBounds) == 0x000508, "Member 'UHoudiniStaticMeshComponent::LocalBounds' has a wrong offset!");
static_assert(offsetof(UHoudiniStaticMeshComponent, bHoudiniIconVisible) == 0x000524, "Member 'UHoudiniStaticMeshComponent::bHoudiniIconVisible' has a wrong offset!");
