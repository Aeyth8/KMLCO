...
#include "BP_Explosion_ExplosiveCanister_classes.hpp"
#include "BP_Explosion_ExplosiveCanister_parameters.hpp"
...
void ABP_Explosion_ExplosiveCanister_C::ExecuteUbergraph_BP_Explosion_ExplosiveCanister(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Explosion_ExplosiveCanister_C", "ExecuteUbergraph_BP_Explosion_ExplosiveCanister");

	Params::BP_Explosion_ExplosiveCanister_C_ExecuteUbergraph_BP_Explosion_ExplosiveCanister Parms{};
...
void ABP_Explosion_ExplosiveCanister_C::OnTrigger(const struct FVector& Epicenter, float Radius, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Explosion_ExplosiveCanister_C", "OnTrigger");

	Params::BP_Explosion_ExplosiveCanister_C_OnTrigger Parms{};
