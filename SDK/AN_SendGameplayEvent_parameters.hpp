...
public:
	...
	bool                                          CallFunc_IsMeshDealingWithAnimNotifies_ReturnValue; // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AN_SendGameplayEvent_C_Received_Notify) == 0x000028, "Wrong size on AN_SendGameplayEvent_C_Received_Notify");
...
static_assert(offsetof(AN_SendGameplayEvent_C_Received_Notify, CallFunc_IsMeshDealingWithAnimNotifies_ReturnValue) == 0x000011, "Member 'AN_SendGameplayEvent_C_Received_Notify::CallFunc_IsMeshDealingWithAnimNotifies_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(AN_SendGameplayEvent_C_Received_Notify, CallFunc_IsValid_ReturnValue) == 0x000020, "Member 'AN_SendGameplayEvent_C_Received_Notify::CallFunc_IsValid_ReturnValue' has a wrong offset!");
