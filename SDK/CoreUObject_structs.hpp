...
public:
	...
	uint8                                         Pad_3C[0x4C];                                      // 0x003C(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAssetData) == 0x000008, "Wrong alignment on FAssetData");
static_assert(sizeof(FAssetData) == 0x000088, "Wrong size on FAssetData");
...
public:
	...
	TSet<class FName>                             RecursiveClassesExclusionSet;                      // 0x00A0(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FARFilter) == 0x000100, "Wrong size on FARFilter");
...
static_assert(offsetof(FARFilter, bRecursivePaths) == 0x0000F0, "Member 'FARFilter::bRecursivePaths' has a wrong offset!");
static_assert(offsetof(FARFilter, bRecursiveClasses) == 0x0000F1, "Member 'FARFilter::bRecursiveClasses' has a wrong offset!");
static_assert(offsetof(FARFilter, bIncludeOnlyOnDiskAssets) == 0x0000F2, "Member 'FARFilter::bIncludeOnlyOnDiskAssets' has a wrong offset!");
