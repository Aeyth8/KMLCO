...
#include "BP_ExplosionTankSlam_classes.hpp"
#include "BP_ExplosionTankSlam_parameters.hpp"
...
void ABP_ExplosionTankSlam_C::ExecuteUbergraph_BP_ExplosionTankSlam(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionTankSlam_C", "ExecuteUbergraph_BP_ExplosionTankSlam");

	Params::BP_ExplosionTankSlam_C_ExecuteUbergraph_BP_ExplosionTankSlam Parms{};
...
void ABP_ExplosionTankSlam_C::OnTrigger(const struct FVector& Epicenter_0, float Radius_0, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionTankSlam_C", "OnTrigger");

	Params::BP_ExplosionTankSlam_C_OnTrigger Parms{};
