...
// Function Niagara.NiagaraComponent.PrestreamTextures
// 0x000C (0x000C - 0x0000)
struct NiagaraComponent_PrestreamTextures final
{
public:
...
static_assert(alignof(NiagaraComponent_PrestreamTextures) == 0x000004, "Wrong alignment on NiagaraComponent_PrestreamTextures");
static_assert(sizeof(NiagaraComponent_PrestreamTextures) == 0x00000C, "Wrong size on NiagaraComponent_PrestreamTextures");
static_assert(offsetof(NiagaraComponent_PrestreamTextures, Seconds) == 0x000000, "Member 'NiagaraComponent_PrestreamTextures::Seconds' has a wrong offset!");
static_assert(offsetof(NiagaraComponent_PrestreamTextures, bPrioritizeCharacterTextures) == 0x000004, "Member 'NiagaraComponent_PrestreamTextures::bPrioritizeCharacterTextures' has a wrong offset!");
static_assert(offsetof(NiagaraComponent_PrestreamTextures, CinematicTextureGroups) == 0x000008, "Member 'NiagaraComponent_PrestreamTextures::CinematicTextureGroups' has a wrong offset!");
