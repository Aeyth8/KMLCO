...
{
public:
	bool                                          bIsPassthrough;                                    // 0x07E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsUsingP2PSockets;                                // 0x07E1(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_7E2[0x6];                                      // 0x07E2(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetDriverEOS) == 0x0007E8, "Wrong size on UNetDriverEOS");
static_assert(offsetof(UNetDriverEOS, bIsPassthrough) == 0x0007E0, "Member 'UNetDriverEOS::bIsPassthrough' has a wrong offset!");
static_assert(offsetof(UNetDriverEOS, bIsUsingP2PSockets) == 0x0007E1, "Member 'UNetDriverEOS::bIsUsingP2PSockets' has a wrong offset!");
...
static_assert(sizeof(UNetConnectionEOS) == 0x001CC0, "Wrong size on UNetConnectionEOS");
