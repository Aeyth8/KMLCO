...
{
public:
	struct FSlateBrush                            InIconRimBrush;                                    // 0x0000(0x0090)(Parm, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonActionWidget_SetIconRimBrush) == 0x000008, "Wrong alignment on CommonActionWidget_SetIconRimBrush");
static_assert(sizeof(CommonActionWidget_SetIconRimBrush) == 0x000090, "Wrong size on CommonActionWidget_SetIconRimBrush");
...
public:
	...
	struct FSlateBrush                            ReturnValue;                                       // 0x0028(0x0090)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(CommonUISubsystemBase_GetInputActionButtonIcon) == 0x0000B8, "Wrong size on CommonUISubsystemBase_GetInputActionButtonIcon");
...
static_assert(offsetof(CommonUISubsystemBase_GetInputActionButtonIcon, ReturnValue) == 0x000028, "Member 'CommonUISubsystemBase_GetInputActionButtonIcon::ReturnValue' has a wrong offset!");
...
public:
	...
	class FName                                   InProgressMaterialParam;                           // 0x0090(0x000C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(CommonButtonBase_SetInputActionProgressMaterial) == 0x0000A0, "Wrong size on CommonButtonBase_SetInputActionProgressMaterial");
...
static_assert(offsetof(CommonButtonBase_SetInputActionProgressMaterial, InProgressMaterialParam) == 0x000090, "Member 'CommonButtonBase_SetInputActionProgressMaterial::InProgressMaterialParam' has a wrong offset!");
...
public:
	...
	TDelegate<void(class UObject* Object)>        OnAssetLoaded;                                     // 0x0030(0x0014)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	class FName                                   TabNameID;                                         // 0x0000(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonButtonBase*                      ReturnValue;                                       // 0x0010(0x0008)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	class FName                                   TabNameID;                                         // 0x0000(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonButtonBase*                      TabButton;                                         // 0x0010(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	class FName                                   TabNameID;                                         // 0x0000(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UCommonButtonBase>          ButtonWidgetType;                                  // 0x0010(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidget*                                ContentWidget;                                     // 0x0018(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(CommonTabListWidgetBase_RegisterTab, ReturnValue) == 0x000020, "Member 'CommonTabListWidgetBase_RegisterTab::ReturnValue' has a wrong offset!");
...
{
public:
	struct FSlateBrush                            OutStrikeBrush;                                    // 0x0000(0x0090)(Parm, OutParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonTextStyle_GetStrikeBrush) == 0x000008, "Wrong alignment on CommonTextStyle_GetStrikeBrush");
static_assert(sizeof(CommonTextStyle_GetStrikeBrush) == 0x000090, "Wrong size on CommonTextStyle_GetStrikeBrush");
