...
public:
	...
	struct FLiveLinkSubjectName                   LiveLinkSubjectName;                               // 0x0020(0x000C)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class ULiveLinkRetargetAsset>     RetargetAsset;                                     // 0x0030(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoClear, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULiveLinkRetargetAsset*                 CurrentRetargetAsset;                              // 0x0038(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FAnimNode_LiveLinkPose                 PoseNode;                                          // 0x0770(0x0058)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x0007D0, "Wrong size on FLiveLinkInstanceProxy");
