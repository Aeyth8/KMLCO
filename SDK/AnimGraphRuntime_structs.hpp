...
enum class EDrivenBoneModificationMode : uint8
{
	...
	ReplaceComponent                         = 1,
	AddToRefPose                             = 2,
	SwingTwistRotation                       = 3,
	EDrivenBoneModificationMode_MAX          = 4,
};
...
// 0x02C0 (0x0A30 - 0x0770)
struct FAnimSequencerInstanceProxy : public FAnimInstanceProxy
{
public:
	uint8                                         Pad_770[0x2C0];                                    // 0x0770(0x02C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	bool                                          bUseNormalisedTime;                                // 0x0044(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldLoop;                                       // 0x0045(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTeleportToExplicitTime;                           // 0x0046(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESequenceEvalReinit                           ReinitializationBehavior;                          // 0x0047(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_SequenceEvaluator, bUseNormalisedTime) == 0x000044, "Member 'FAnimNode_SequenceEvaluator::bUseNormalisedTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, bShouldLoop) == 0x000045, "Member 'FAnimNode_SequenceEvaluator::bShouldLoop' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, bTeleportToExplicitTime) == 0x000046, "Member 'FAnimNode_SequenceEvaluator::bTeleportToExplicitTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, ReinitializationBehavior) == 0x000047, "Member 'FAnimNode_SequenceEvaluator::ReinitializationBehavior' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator, StartPosition) == 0x00004C, "Member 'FAnimNode_SequenceEvaluator::StartPosition' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x00017C, "Member 'FAnimNode_AimOffsetLookAt::LookAtLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketAxis) == 0x000188, "Member 'FAnimNode_AimOffsetLookAt::SocketAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, Alpha) == 0x000194, "Member 'FAnimNode_AimOffsetLookAt::Alpha' has a wrong offset!");
...
public:
	...
	bool                                          bSimpleRBF;                                        // 0x0124(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_125[0x3];                                      // 0x0125(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                VRBFVector;                                        // 0x0128(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                VRBFValuesXYZpos;                                  // 0x0134(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                VRBFValuesXYZneg;                                  // 0x0140(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawDebug;                                        // 0x014C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPreserveChildBoneTransforms;                      // 0x014D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14E[0x2];                                      // 0x014E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FBoneReference>                 ChildBones;                                        // 0x0150(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	EDrivenDestinationMode                        DestinationMode;                                   // 0x0160(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDrivenBoneModificationMode                   ModificationMode;                                  // 0x0161(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EComponentType                                SourceComponent;                                   // 0x0162(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bUseRange : 1;                                     // 0x0163(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetTranslationX : 1;                     // 0x0163(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetTranslationY : 1;                     // 0x0163(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetTranslationZ : 1;                     // 0x0163(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetRotationX : 1;                        // 0x0163(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetRotationY : 1;                        // 0x0163(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetRotationZ : 1;                        // 0x0163(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetScaleX : 1;                           // 0x0163(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetScaleY : 1;                           // 0x0164(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectTargetScaleZ : 1;                           // 0x0164(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FAnimNode_BoneDrivenController, bSimpleRBF) == 0x000124, "Member 'FAnimNode_BoneDrivenController::bSimpleRBF' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, VRBFVector) == 0x000128, "Member 'FAnimNode_BoneDrivenController::VRBFVector' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, VRBFValuesXYZpos) == 0x000134, "Member 'FAnimNode_BoneDrivenController::VRBFValuesXYZpos' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, VRBFValuesXYZneg) == 0x000140, "Member 'FAnimNode_BoneDrivenController::VRBFValuesXYZneg' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, bDrawDebug) == 0x00014C, "Member 'FAnimNode_BoneDrivenController::bDrawDebug' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, bPreserveChildBoneTransforms) == 0x00014D, "Member 'FAnimNode_BoneDrivenController::bPreserveChildBoneTransforms' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ChildBones) == 0x000150, "Member 'FAnimNode_BoneDrivenController::ChildBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, DestinationMode) == 0x000160, "Member 'FAnimNode_BoneDrivenController::DestinationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ModificationMode) == 0x000161, "Member 'FAnimNode_BoneDrivenController::ModificationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceComponent) == 0x000162, "Member 'FAnimNode_BoneDrivenController::SourceComponent' has a wrong offset!");
...
public:
	...
	bool                                          bSwingTwistRotationBlend;                          // 0x0054(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEulerRotationBlend;                               // 0x0055(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bSwingTwistRotationBlend) == 0x000054, "Member 'FAnimNode_LayeredBoneBlend::bSwingTwistRotationBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_LayeredBoneBlend, bEulerRotationBlend) == 0x000055, "Member 'FAnimNode_LayeredBoneBlend::bEulerRotationBlend' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseByName, PoseWeight) == 0x00008C, "Member 'FAnimNode_PoseByName::PoseWeight' has a wrong offset!");
...
public:
	...
	uint8                                         bOnlyDriveSelectedBones : 1;                       // 0x0132(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_133[0x1];                                      // 0x0133(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         LODThreshold;                                      // 0x0134(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_PoseDriver, RBFParams) == 0x000104, "Member 'FAnimNode_PoseDriver::RBFParams' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, LODThreshold) == 0x000134, "Member 'FAnimNode_PoseDriver::LODThreshold' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_21C[0x634];                                    // 0x021C(0x0634)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	struct FRotator                               MeshToComponent;                                   // 0x00BC(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                Offset;                                            // 0x00C8(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_RotateRootBone, MeshToComponent) == 0x0000BC, "Member 'FAnimNode_RotateRootBone::MeshToComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotateRootBone, Offset) == 0x0000C8, "Member 'FAnimNode_RotateRootBone::Offset' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x00015C, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x000190, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x000191, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
...
public:
	...
	EAnimAlphaInputType                           AlphaInputType;                                    // 0x00C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAlphaBoolEnabled;                                 // 0x00C9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AlphaCurveFromMontage;                             // 0x00CA(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_Slot) == 0x0000E8, "Wrong size on FAnimNode_Slot");
...
static_assert(offsetof(FAnimNode_Slot, Alpha) == 0x000030, "Member 'FAnimNode_Slot::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, AlphaScaleBias) == 0x000034, "Member 'FAnimNode_Slot::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, AlphaBoolBlend) == 0x000040, "Member 'FAnimNode_Slot::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, AlphaCurveName) == 0x000088, "Member 'FAnimNode_Slot::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, AlphaScaleBiasClamp) == 0x000094, "Member 'FAnimNode_Slot::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, AlphaInputType) == 0x0000C8, "Member 'FAnimNode_Slot::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, bAlphaBoolEnabled) == 0x0000C9, "Member 'FAnimNode_Slot::bAlphaBoolEnabled' has a wrong offset!");
static_assert(offsetof(FAnimNode_Slot, AlphaCurveFromMontage) == 0x0000CA, "Member 'FAnimNode_Slot::AlphaCurveFromMontage' has a wrong offset!");
...
public:
	...
	uint8                                         bLimitSqueeze : 1;                                 // 0x0119(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bLimitRotation : 1;                                // 0x0119(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUsePlanarLimit : 1;                               // 0x0119(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bActorSpaceFakeVel : 1;                            // 0x0119(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReorientParentToChild : 1;                        // 0x0119(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	float                                         SqueezeLimit;                                      // 0x0214(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                FakeVelocity;                                      // 0x0218(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBoneReference                         BaseJoint;                                         // 0x0224(0x0014)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FAnimNode_Trail, SqueezeLimit) == 0x000214, "Member 'FAnimNode_Trail::SqueezeLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, FakeVelocity) == 0x000218, "Member 'FAnimNode_Trail::FakeVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, BaseJoint) == 0x000224, "Member 'FAnimNode_Trail::BaseJoint' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, LastBoneRotationAnimAlphaBlend) == 0x000238, "Member 'FAnimNode_Trail::LastBoneRotationAnimAlphaBlend' has a wrong offset!");
...
public:
	...
	bool                                          bSwingTwistRotationBlend;                          // 0x0203(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTwistCCW;                                         // 0x0204(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bMaintainEffectorRelRot : 1;                       // 0x0205(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowTwist : 1;                                   // 0x0205(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FAnimNode_TwoBoneIK, bSwingTwistRotationBlend) == 0x000203, "Member 'FAnimNode_TwoBoneIK::bSwingTwistRotationBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, bTwistCCW) == 0x000204, "Member 'FAnimNode_TwoBoneIK::bTwistCCW' has a wrong offset!");
