...
enum class EGameplayEffectMagnitudeCalculation : uint8
{
	...
	CASetByGameDB                            = 81,
	CASetByTableCell                         = 82,
	CASetByMagnitudeAwareDataAsset           = 83,
	EGameplayEffectMagnitudeCalculation_MAX  = 84,
};
...
// ScriptStruct GameplayAbilities.GameplayCueTargetDataHandle
// 0x0028 (0x0028 - 0x0000)
struct alignas(0x08) FGameplayCueTargetDataHandle final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayCueTargetDataHandle) == 0x000008, "Wrong alignment on FGameplayCueTargetDataHandle");
static_assert(sizeof(FGameplayCueTargetDataHandle) == 0x000028, "Wrong size on FGameplayCueTargetDataHandle");
...
public:
	...
	struct FGameplayCueTargetDataHandle           TargetData;                                        // 0x00C8(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayCueParameters) == 0x000008, "Wrong alignment on FGameplayCueParameters");
static_assert(sizeof(FGameplayCueParameters) == 0x0000F0, "Wrong size on FGameplayCueParameters");
...
static_assert(offsetof(FGameplayCueParameters, bReplicateLocationWhenUsingMinimalRepProxy) == 0x0000C0, "Member 'FGameplayCueParameters::bReplicateLocationWhenUsingMinimalRepProxy' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, TargetData) == 0x0000C8, "Member 'FGameplayCueParameters::TargetData' has a wrong offset!");
...
public:
	...
	struct FGameplayCueParameters                 Parameters;                                        // 0x0028(0x00F0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bPredictivelyRemoved;                              // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_119[0x7];                                      // 0x0119(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveGameplayCue) == 0x000008, "Wrong alignment on FActiveGameplayCue");
static_assert(sizeof(FActiveGameplayCue) == 0x000120, "Wrong size on FActiveGameplayCue");
...
static_assert(offsetof(FActiveGameplayCue, bPredictivelyRemoved) == 0x000118, "Member 'FActiveGameplayCue::bPredictivelyRemoved' has a wrong offset!");
...
// ScriptStruct GameplayAbilities.CASetByTableCellFloat
// 0x0028 (0x0028 - 0x0000)
struct FCASetByTableCellFloat final
{
public:
	struct FDataTableCellHandle                   ValueTable;                                        // 0x0000(0x0020)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_20[0x8];                                       // 0x0020(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCASetByTableCellFloat) == 0x000008, "Wrong alignment on FCASetByTableCellFloat");
static_assert(sizeof(FCASetByTableCellFloat) == 0x000028, "Wrong size on FCASetByTableCellFloat");
static_assert(offsetof(FCASetByTableCellFloat, ValueTable) == 0x000000, "Member 'FCASetByTableCellFloat::ValueTable' has a wrong offset!");

// ScriptStruct GameplayAbilities.CASetByGameDBFloat
// 0x0014 (0x0014 - 0x0000)
struct FCASetByGameDBFloat final
{
public:
	struct FCAGameDatabaseCellHandle              ValueTable;                                        // 0x0000(0x000C)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x8];                                        // 0x000C(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCASetByGameDBFloat) == 0x000004, "Wrong alignment on FCASetByGameDBFloat");
static_assert(sizeof(FCASetByGameDBFloat) == 0x000014, "Wrong size on FCASetByGameDBFloat");
static_assert(offsetof(FCASetByGameDBFloat, ValueTable) == 0x000000, "Member 'FCASetByGameDBFloat::ValueTable' has a wrong offset!");

// ScriptStruct GameplayAbilities.CASetByTableFloat
// 0x0020 (0x0020 - 0x0000)
struct FCASetByTableFloat final
{
public:
	struct FDataTableRowHandle                    ValueTable;                                        // 0x0000(0x0018)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_18[0x8];                                       // 0x0018(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCASetByTableFloat) == 0x000008, "Wrong alignment on FCASetByTableFloat");
static_assert(sizeof(FCASetByTableFloat) == 0x000020, "Wrong size on FCASetByTableFloat");
static_assert(offsetof(FCASetByTableFloat, ValueTable) == 0x000000, "Member 'FCASetByTableFloat::ValueTable' has a wrong offset!");
...
// ScriptStruct GameplayAbilities.CASetByMagnitudeAwareDataAsset
// 0x0010 (0x0010 - 0x0000)
struct FCASetByMagnitudeAwareDataAsset final
{
public:
	class UCAMagnitudeAwareDataAsset*             DataAsset;                                         // 0x0000(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCASetByMagnitudeAwareDataAsset) == 0x000008, "Wrong alignment on FCASetByMagnitudeAwareDataAsset");
static_assert(sizeof(FCASetByMagnitudeAwareDataAsset) == 0x000010, "Wrong size on FCASetByMagnitudeAwareDataAsset");
static_assert(offsetof(FCASetByMagnitudeAwareDataAsset, DataAsset) == 0x000000, "Member 'FCASetByMagnitudeAwareDataAsset::DataAsset' has a wrong offset!");
...
public:
	...
	struct FCASetByTableFloat                     SetByTableMagnitude;                               // 0x0268(0x0020)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FCASetByTableCellFloat                 SetByTableCellMagnitude;                           // 0x0288(0x0028)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FCASetByGameDBFloat                    SetByGameDBMagnitude;                              // 0x02B0(0x0014)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C4[0x4];                                      // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCASetByMagnitudeAwareDataAsset        SetByMagnitudeAwareDataAsset;                      // 0x02C8(0x0010)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FGameplayEffectModifierMagnitude) == 0x000008, "Wrong alignment on FGameplayEffectModifierMagnitude");
static_assert(sizeof(FGameplayEffectModifierMagnitude) == 0x0002D8, "Wrong size on FGameplayEffectModifierMagnitude");
...
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByTableMagnitude) == 0x000268, "Member 'FGameplayEffectModifierMagnitude::SetByTableMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByTableCellMagnitude) == 0x000288, "Member 'FGameplayEffectModifierMagnitude::SetByTableCellMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByGameDBMagnitude) == 0x0002B0, "Member 'FGameplayEffectModifierMagnitude::SetByGameDBMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByMagnitudeAwareDataAsset) == 0x0002C8, "Member 'FGameplayEffectModifierMagnitude::SetByMagnitudeAwareDataAsset' has a wrong offset!");
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0050(0x02D8)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayModEvaluationChannelSettings  EvaluationChannelSettings;                         // 0x0328(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_329[0x7];                                      // 0x0329(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0330(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0370(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FGameplayEffectExecutionScopedModifierInfo) == 0x0003B0, "Wrong size on FGameplayEffectExecutionScopedModifierInfo");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, EvaluationChannelSettings) == 0x000328, "Member 'FGameplayEffectExecutionScopedModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, SourceTags) == 0x000330, "Member 'FGameplayEffectExecutionScopedModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x000370, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
...
public:
	...
	struct FGameplayCueParameters                 CueParameters;                                     // 0x00B8(0x00F0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayCuePendingExecute) == 0x000008, "Wrong alignment on FGameplayCuePendingExecute");
static_assert(sizeof(FGameplayCuePendingExecute) == 0x0001A8, "Wrong size on FGameplayCuePendingExecute");
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0078(0x02D8)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayModEvaluationChannelSettings  EvaluationChannelSettings;                         // 0x0350(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_351[0x7];                                      // 0x0351(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0358(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0398(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayModifierInfo) == 0x000008, "Wrong alignment on FGameplayModifierInfo");
static_assert(sizeof(FGameplayModifierInfo) == 0x0003D8, "Wrong size on FGameplayModifierInfo");
...
static_assert(offsetof(FGameplayModifierInfo, EvaluationChannelSettings) == 0x000350, "Member 'FGameplayModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, SourceTags) == 0x000358, "Member 'FGameplayModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, TargetTags) == 0x000398, "Member 'FGameplayModifierInfo::TargetTags' has a wrong offset!");
...
// ScriptStruct GameplayAbilities.CAGameplayEffectTableValueRow
// 0x0008 (0x0010 - 0x0008)
struct FCAGameplayEffectTableValueRow final : public FTableRowBase
{
public:
...
static_assert(alignof(FCAGameplayEffectTableValueRow) == 0x000008, "Wrong alignment on FCAGameplayEffectTableValueRow");
static_assert(sizeof(FCAGameplayEffectTableValueRow) == 0x000010, "Wrong size on FCAGameplayEffectTableValueRow");
static_assert(offsetof(FCAGameplayEffectTableValueRow, M_value) == 0x000008, "Member 'FCAGameplayEffectTableValueRow::M_value' has a wrong offset!");
...
// ScriptStruct GameplayAbilities.GameplayCueTargetData
// 0x0008 (0x0008 - 0x0000)
struct alignas(0x08) FGameplayCueTargetData
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayCueTargetData) == 0x000008, "Wrong alignment on FGameplayCueTargetData");
static_assert(sizeof(FGameplayCueTargetData) == 0x000008, "Wrong size on FGameplayCueTargetData");
