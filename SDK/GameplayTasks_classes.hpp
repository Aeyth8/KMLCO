...
{
public:
	uint8                                         Pad_F0[0xC];                                       // 0x00F0(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_FC_0 : 1;                                   // 0x00FC(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bIsNetDirty : 1;                                   // 0x00FC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	...
	FMulticastInlineDelegateProperty_             OnClaimedResourcesChange;                          // 0x0150(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
