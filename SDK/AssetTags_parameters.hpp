...
{
public:
	struct FAssetData                             AssetData;                                         // 0x0000(0x0088)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           ReturnValue;                                       // 0x0088(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(AssetTagsSubsystem_GetCollectionsContainingAssetData) == 0x000098, "Wrong size on AssetTagsSubsystem_GetCollectionsContainingAssetData");
...
static_assert(offsetof(AssetTagsSubsystem_GetCollectionsContainingAssetData, ReturnValue) == 0x000088, "Member 'AssetTagsSubsystem_GetCollectionsContainingAssetData::ReturnValue' has a wrong offset!");
