...
void UBinkMediaPlayer::SetCAAudioData(class UObject* Data)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "SetCAAudioData");

	Params::BinkMediaPlayer_SetCAAudioData Parms{};
...
int32 UBinkMediaPlayer::GetHeight() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "GetHeight");

	Params::BinkMediaPlayer_GetHeight Parms{};
...
int32 UBinkMediaPlayer::GetWidth() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "GetWidth");

	Params::BinkMediaPlayer_GetWidth Parms{};
