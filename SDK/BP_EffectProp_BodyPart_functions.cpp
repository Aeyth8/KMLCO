...
#include "BP_EffectProp_BodyPart_parameters.hpp"
...
void ABP_EffectProp_BodyPart_C::ExecuteUbergraph_BP_EffectProp_BodyPart(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EffectProp_BodyPart_C", "ExecuteUbergraph_BP_EffectProp_BodyPart");

	Params::BP_EffectProp_BodyPart_C_ExecuteUbergraph_BP_EffectProp_BodyPart Parms{};
...
void ABP_EffectProp_BodyPart_C::OnSplat(int32 Splat_counter, class UPrimitiveComponent* Hit_component, class AActor* Other_actor, class UPrimitiveComponent* Other_comp, const struct FVector& Normal_impulse, const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_EffectProp_BodyPart_C", "OnSplat");

	Params::BP_EffectProp_BodyPart_C_OnSplat Parms{};
