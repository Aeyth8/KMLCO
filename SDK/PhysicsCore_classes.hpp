...
public:
	...
	struct FLinearColor                           TintColour;                                        // 0x006C(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsHollow;                                          // 0x007C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPhysicalMaterial, TintColour) == 0x00006C, "Member 'UPhysicalMaterial::TintColour' has a wrong offset!");
static_assert(offsetof(UPhysicalMaterial, IsHollow) == 0x00007C, "Member 'UPhysicalMaterial::IsHollow' has a wrong offset!");
