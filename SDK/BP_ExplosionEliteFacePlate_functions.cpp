...
#include "BP_ExplosionEliteFacePlate_classes.hpp"
#include "BP_ExplosionEliteFacePlate_parameters.hpp"
...
void ABP_ExplosionEliteFacePlate_C::ExecuteUbergraph_BP_ExplosionEliteFacePlate(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionEliteFacePlate_C", "ExecuteUbergraph_BP_ExplosionEliteFacePlate");

	Params::BP_ExplosionEliteFacePlate_C_ExecuteUbergraph_BP_ExplosionEliteFacePlate Parms{};
...
void ABP_ExplosionEliteFacePlate_C::OnTrigger(const struct FVector& Epicenter, float Radius, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionEliteFacePlate_C", "OnTrigger");

	Params::BP_ExplosionEliteFacePlate_C_OnTrigger Parms{};
