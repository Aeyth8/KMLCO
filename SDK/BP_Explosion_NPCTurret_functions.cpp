...
#include "BP_Explosion_NPCTurret_classes.hpp"
#include "BP_Explosion_NPCTurret_parameters.hpp"
...
void ABP_Explosion_NPCTurret_C::ExecuteUbergraph_BP_Explosion_NPCTurret(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Explosion_NPCTurret_C", "ExecuteUbergraph_BP_Explosion_NPCTurret");

	Params::BP_Explosion_NPCTurret_C_ExecuteUbergraph_BP_Explosion_NPCTurret Parms{};
...
void ABP_Explosion_NPCTurret_C::OnTrigger(const struct FVector& Epicenter_0, float Radius_0, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Explosion_NPCTurret_C", "OnTrigger");

	Params::BP_Explosion_NPCTurret_C_OnTrigger Parms{};
