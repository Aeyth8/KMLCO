...
#include "BP_ExplosionUntouchable_classes.hpp"
#include "BP_ExplosionUntouchable_parameters.hpp"
...
void ABP_ExplosionUntouchable_C::ExecuteUbergraph_BP_ExplosionUntouchable(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionUntouchable_C", "ExecuteUbergraph_BP_ExplosionUntouchable");

	Params::BP_ExplosionUntouchable_C_ExecuteUbergraph_BP_ExplosionUntouchable Parms{};
...
void ABP_ExplosionUntouchable_C::OnTrigger(const struct FVector& Epicenter, float Radius, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionUntouchable_C", "OnTrigger");

	Params::BP_ExplosionUntouchable_C_OnTrigger Parms{};
