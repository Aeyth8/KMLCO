...
struct FActiveGameplayEffectHandle UGameplayAbility::BP_ApplyGameplayEffectToOwner(TSubclassOf<class UGameplayEffect> GameplayEffectClass, int32 GameplayEffectLevel, int32 Stacks, float Period)
{
...
void UGameplayAbility::K2_ExecuteGameplayCueWithParamsOnTarget(class UAbilitySystemComponent* AbilitySystemComponent, const struct FGameplayTag& GameplayCueTag, const struct FGameplayCueParameters& GameplayCueParameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameplayAbility", "K2_ExecuteGameplayCueWithParamsOnTarget");

	Params::GameplayAbility_K2_ExecuteGameplayCueWithParamsOnTarget Parms{};
...
void UGameplayAbility::MontageJumpToSection(class FName SectionName, float InPlayRate)
{
	static class UFunction* Func = nullptr;
...
void UGameplayAbility::MontageSetPlayRate(float InPlayRate)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameplayAbility", "MontageSetPlayRate");

	Params::GameplayAbility_MontageSetPlayRate Parms{};
...
// int32                                   MontagePriority_0                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    EnableInterruptEventAfterBlendOut                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UAbilityTask_PlayMontageAndWait* UAbilityTask_PlayMontageAndWait::CreatePlayMontageAndWaitProxy(class UGameplayAbility* OwningAbility, class FName TaskInstanceName, class UAnimMontage* MontageToPlay_0, float Rate_0, class FName StartSection_0, bool bStopWhenAbilityEnds_0, float AnimRootMotionTranslationScale_0, float StartTimeSeconds_0, int32 MontagePriority_0, bool EnableInterruptEventAfterBlendOut)
{
	...
	Parms.MontagePriority_0 = MontagePriority_0;
	Parms.EnableInterruptEventAfterBlendOut = EnableInterruptEventAfterBlendOut;
