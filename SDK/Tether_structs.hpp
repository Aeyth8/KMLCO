...
public:
	...
	struct FTetherCableSimulationOptions          SimulationOptions;                                 // 0x0030(0x0034)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTetherSegmentSimulationParams> SegmentParams;                                     // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FTetherSimulationParams) == 0x000110, "Wrong size on FTetherSimulationParams");
...
static_assert(offsetof(FTetherSimulationParams, SegmentParams) == 0x000068, "Member 'FTetherSimulationParams::SegmentParams' has a wrong offset!");
