...
#include "BP_ExplosionEliteArmour_classes.hpp"
#include "BP_ExplosionEliteArmour_parameters.hpp"
...
void ABP_ExplosionEliteArmour_C::ExecuteUbergraph_BP_ExplosionEliteArmour(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionEliteArmour_C", "ExecuteUbergraph_BP_ExplosionEliteArmour");

	Params::BP_ExplosionEliteArmour_C_ExecuteUbergraph_BP_ExplosionEliteArmour Parms{};
...
void ABP_ExplosionEliteArmour_C::OnTrigger(const struct FVector& Epicenter, float Radius, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionEliteArmour_C", "OnTrigger");

	Params::BP_ExplosionEliteArmour_C_OnTrigger Parms{};
