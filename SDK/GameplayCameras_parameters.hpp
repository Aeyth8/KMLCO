...
public:
	...
	struct FMinimalViewInfo                       POV;                                               // 0x0010(0x06D0)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMinimalViewInfo                       ModifiedPOV;                                       // 0x06E0(0x06D0)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(MatineeCameraShake_BlueprintUpdateCameraShake) == 0x000DB0, "Wrong size on MatineeCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(MatineeCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x0006E0, "Member 'MatineeCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");
