...
#include "BP_Explosion_EMPProjectileDestroy_classes.hpp"
#include "BP_Explosion_EMPProjectileDestroy_parameters.hpp"
...
void ABP_Explosion_EMPProjectileDestroy_C::ExecuteUbergraph_BP_Explosion_EMPProjectileDestroy(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Explosion_EMPProjectileDestroy_C", "ExecuteUbergraph_BP_Explosion_EMPProjectileDestroy");

	Params::BP_Explosion_EMPProjectileDestroy_C_ExecuteUbergraph_BP_Explosion_EMPProjectileDestroy Parms{};
...
void ABP_Explosion_EMPProjectileDestroy_C::OnTrigger(const struct FVector& Epicenter_0, float Radius_0, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Explosion_EMPProjectileDestroy_C", "OnTrigger");

	Params::BP_Explosion_EMPProjectileDestroy_C_OnTrigger Parms{};
