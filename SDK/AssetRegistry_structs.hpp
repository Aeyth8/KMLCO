...
public:
	...
	bool                                          bIncludeFeatureReferences;                         // 0x0005(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAssetRegistryDependencyOptions) == 0x000001, "Wrong alignment on FAssetRegistryDependencyOptions");
static_assert(sizeof(FAssetRegistryDependencyOptions) == 0x000006, "Wrong size on FAssetRegistryDependencyOptions");
...
static_assert(offsetof(FAssetRegistryDependencyOptions, bIncludeFeatureReferences) == 0x000005, "Member 'FAssetRegistryDependencyOptions::bIncludeFeatureReferences' has a wrong offset!");
