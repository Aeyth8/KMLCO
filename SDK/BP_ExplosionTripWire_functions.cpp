...
#include "BP_ExplosionTripWire_classes.hpp"
#include "BP_ExplosionTripWire_parameters.hpp"
...
void ABP_ExplosionTripWire_C::ExecuteUbergraph_BP_ExplosionTripWire(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionTripWire_C", "ExecuteUbergraph_BP_ExplosionTripWire");

	Params::BP_ExplosionTripWire_C_ExecuteUbergraph_BP_ExplosionTripWire Parms{};
...
void ABP_ExplosionTripWire_C::OnTrigger(const struct FVector& Epicenter, float Radius, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionTripWire_C", "OnTrigger");

	Params::BP_ExplosionTripWire_C_OnTrigger Parms{};
