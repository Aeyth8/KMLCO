...
// Parameters:
// struct FGuid                            PersistentGuid                                         (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bIncludeOnlyOnDiskAssets                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FAssetData                       ReturnValue                                            (Parm, OutParm, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

struct FAssetData IAssetRegistry::GetAssetByGuid(const struct FGuid& PersistentGuid, bool bIncludeOnlyOnDiskAssets) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AssetRegistry", "GetAssetByGuid");

	Params::AssetRegistry_GetAssetByGuid Parms{};

	Parms.PersistentGuid = std::move(PersistentGuid);
	Parms.bIncludeOnlyOnDiskAssets = bIncludeOnlyOnDiskAssets;
