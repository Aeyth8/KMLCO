...
#include "BP_WallPanel_Destruction_classes.hpp"
#include "BP_WallPanel_Destruction_parameters.hpp"
...
void ABP_WallPanel_Destruction_C::ExecuteUbergraph_BP_WallPanel_Destruction(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WallPanel_Destruction_C", "ExecuteUbergraph_BP_WallPanel_Destruction");

	Params::BP_WallPanel_Destruction_C_ExecuteUbergraph_BP_WallPanel_Destruction Parms{};
...
void ABP_WallPanel_Destruction_C::OnTrigger(const struct FVector& Epicenter, float Radius, bool Attached_to_surface, const struct FVector& Surface_normal, const struct FVector& Incoming_direction, bool Friendly, float Duration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WallPanel_Destruction_C", "OnTrigger");

	Params::BP_WallPanel_Destruction_C_OnTrigger Parms{};
