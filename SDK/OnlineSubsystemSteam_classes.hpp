...
{
public:
	bool                                          bIsPassthrough;                                    // 0x1CB8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1CB9[0x7];                                     // 0x1CB9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x001CC0, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001CB8, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
...
static_assert(sizeof(USteamNetDriver) == 0x0007E8, "Wrong size on USteamNetDriver");
