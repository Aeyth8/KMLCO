...
// Function BinkMediaPlayer.BinkMediaPlayer.SetCAAudioData
// 0x0008 (0x0008 - 0x0000)
struct BinkMediaPlayer_SetCAAudioData final
{
public:
...
static_assert(alignof(BinkMediaPlayer_SetCAAudioData) == 0x000008, "Wrong alignment on BinkMediaPlayer_SetCAAudioData");
static_assert(sizeof(BinkMediaPlayer_SetCAAudioData) == 0x000008, "Wrong size on BinkMediaPlayer_SetCAAudioData");
static_assert(offsetof(BinkMediaPlayer_SetCAAudioData, Data) == 0x000000, "Member 'BinkMediaPlayer_SetCAAudioData::Data' has a wrong offset!");
...
// Function BinkMediaPlayer.BinkMediaPlayer.GetHeight
// 0x0004 (0x0004 - 0x0000)
struct BinkMediaPlayer_GetHeight final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BinkMediaPlayer_GetHeight) == 0x000004, "Wrong alignment on BinkMediaPlayer_GetHeight");
static_assert(sizeof(BinkMediaPlayer_GetHeight) == 0x000004, "Wrong size on BinkMediaPlayer_GetHeight");
static_assert(offsetof(BinkMediaPlayer_GetHeight, ReturnValue) == 0x000000, "Member 'BinkMediaPlayer_GetHeight::ReturnValue' has a wrong offset!");
...
// Function BinkMediaPlayer.BinkMediaPlayer.GetWidth
// 0x0004 (0x0004 - 0x0000)
struct BinkMediaPlayer_GetWidth final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(BinkMediaPlayer_GetWidth) == 0x000004, "Wrong alignment on BinkMediaPlayer_GetWidth");
static_assert(sizeof(BinkMediaPlayer_GetWidth) == 0x000004, "Wrong size on BinkMediaPlayer_GetWidth");
static_assert(offsetof(BinkMediaPlayer_GetWidth, ReturnValue) == 0x000000, "Member 'BinkMediaPlayer_GetWidth::ReturnValue' has a wrong offset!");
