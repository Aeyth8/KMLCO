...
{
public:
	struct FLiveLinkSubjectRepresentation         SubjectRepresentation;                             // 0x00F0(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	TMap<TSubclassOf<class ULiveLinkRole>, class ULiveLinkControllerBase*> ControllerMap;                                     // 0x0108(0x0050)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, NoClear, Interp, ContainsInstancedReference, NativeAccessSpecifierPublic)
	...
	struct FComponentReference                    ComponentToControl;                                // 0x0170(0x0030)(Edit, DisableEditOnTemplate, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkComponentController) == 0x0001A8, "Wrong size on ULiveLinkComponentController");
...
static_assert(offsetof(ULiveLinkComponentController, ComponentToControl) == 0x000170, "Member 'ULiveLinkComponentController::ComponentToControl' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bDisableEvaluateLiveLinkWhenSpawnable) == 0x0001A0, "Member 'ULiveLinkComponentController::bDisableEvaluateLiveLinkWhenSpawnable' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bEvaluateLiveLink) == 0x0001A1, "Member 'ULiveLinkComponentController::bEvaluateLiveLink' has a wrong offset!");
